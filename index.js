...
app.post("/api/contact", async (req, res) => {
  try {
    const { project, phone, name, email, message, profession, meslek, language = "tr" } = req.body;
    console.log("📥 Received Body:", JSON.stringify(req.body, null, 2));
    const finalProfession = profession || meslek;
    ...
    const adminMailOptions = {
      ...
      html: createAdminEmailTemplate({ project, name, phone, email, message, profession: finalProfession }, language),
    };
    ...
    if (transporter) {
      try {
        ...
        console.log("📝 Form submission received:", { project, name, phone, email, profession: finalProfession });
